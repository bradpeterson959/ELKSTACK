...
![alt text](https://github.com/bradpeterson959/ELKSTACK/blob/main/ELKSTACK/Diagrams/unknown.png)
```diff
...
```
- [CLICK to view - Elk-Server-Deployment Playbook](https://github.com/bradpeterson959/ELKSTACK/blob/main/ELKSTACK/Ansible/elk-server-deployment.yml)
- [CLICK to view - FileBeat Deployment Playbook](Ansible/filebeat-playbook.yml)
- [CLICK to view - MetricBeat Deployment Playbook](https://github.com/bradpeterson959/ELKSTACK/blob/main/ELKSTACK/Ansible/metricbeat-playbook.yml)
...
# Using the Playbook, here is a play by play.
...
```
   - [CLICK to view - Elk-Server-Deployment.yml](https://github.com/bradpeterson959/ELKSTACK/blob/main/ELKSTACK/Ansible/elk-server-deployment.ymll)
```diff
...
change them.
```
   - [CLICK to view - Ansible.cfg](https://github.com/bradpeterson959/ELKSTACK/blob/main/ELKSTACK/Ansible/Ansible.cfg)
```diff
...
```
   - [CLICK to view - Ansible Hosts File](https://github.com/bradpeterson959/ELKSTACK/blob/main/ELKSTACK/Ansible/hosts)
```diff
...
![alt text](https://github.com/bradpeterson959/ELKSTACK/blob/main/ELKSTACK/ScreenShots/PlaybookOutput.png)
...
![alt text](https://github.com/bradpeterson959/ELKSTACK/blob/main/ELKSTACK/ScreenShots/ElkServerAutomation.png)
...
```
   - [CLICK to view - Filebeat-Configuration.yml](https://github.com/bradpeterson959/ELKSTACK/blob/main/ELKSTACK/Ansible/filebeat-configuration.yml)
   - [CLICK to view - Filebeat-Playbook.yml](https://github.com/bradpeterson959/ELKSTACK/blob/main/ELKSTACK/Ansible/filebeat-playbook.yml)
   - [CLICK to view - Metricbeat-Confgiuration.yml](https://github.com/bradpeterson959/ELKSTACK/blob/main/ELKSTACK/Ansible/metricbeat-configuration.yml)
   - [CLICK to view - Metricbeat-Playbook.yml](https://github.com/bradpeterson959/ELKSTACK/blob/main/ELKSTACK/Ansible/metricbeat-playbook.yml)
```diff
...
![alt text](https://github.com/bradpeterson959/ELKSTACK/blob/main/ELKSTACK/ScreenShots/Filebeat.png)
```diff
